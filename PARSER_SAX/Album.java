...
public class Album implements Comparable<Album>{
    ...
    //Constructor
    public Album(String name, String country, String interprete, String ISBN, String company, String aid, String format, int year, String review, ArrayList<Song> songs){
        this.name = name;
