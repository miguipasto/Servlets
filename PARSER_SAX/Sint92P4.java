...
public class Sint92P4 extends HttpServlet {

    
    private final static String contraseña = "SINT4migui";
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res){ 
        ...
        try {
            ...
            /* FASE 11 */
                ...
                countries = modelo.getQ1Countries(); //Obtenemos el arraylist con los countries
                if((req.getParameter("auto") != null) && (req.getParameter("auto").equals("true"))){ //Modo auto activado
            ...
            /* FASE 12 */ 
                ...
                if (req.getParameter("pcountry") == null){ //No intrdouce el parametro pais para buscar sus albumes
                    ...
                    albums = modelo.getQ1Albums(country); //Obtenemos los albumes según el país
            ...
            /* FASE 13 */
                ...
                if (req.getParameter("pcountry") == null){ //Falta el parámetro pcrountry
                    ...
                    songs = modelo.getQ1Songs(country,aid);
                    if((req.getParameter("auto") != null) && (req.getParameter("auto").equals("true"))){ //Modo auto activado
